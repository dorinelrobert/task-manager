...
TaskPage.prototype.render = function (
  ...
  this.titleForm = editFormComponent(
    task.title,
    "taskpage__title",
    "",
    updateTitleHandler
  );
  this.descForm = editFormComponent(
    task.description,
  ...
  this.sessionContainer = sessionContainerComponent(
    task.sessions,
    deleteSessionHandler
  );
...
TaskPage.prototype.updateDOMpage = function (
  ...
  let old = this.page;
  return this.page.parentNode.replaceChild(
    this.render(
      task,
      completeHandler,
      deleteHandler,
...
TaskPage.prototype.updateDOMsetTimeLimit = function (task) {
  this.timeLimit = timeLimitComponent(task.time_limit);
  return this.setTimeLimit.parentNode.replaceChild(
    this.timeLimit,
    this.setTimeLimit
  );
};
